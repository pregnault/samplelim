...
RcppExport SEXP _SampleLIM_copula(SEXP r1SEXP, SEXP r2SEXP, SEXP sigmaSEXP, SEXP mSEXP, SEXP nSEXP, SEXP seedSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SampleLIM_exact_vol(SEXP PSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SampleLIM_frustum_of_simplex(SEXP aSEXP, SEXP z0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SampleLIM_load_sdpa_format_file(SEXP input_fileSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SampleLIM_poly_gen(SEXP kind_genSEXP, SEXP Vpoly_genSEXP, SEXP Zono_genSEXP, SEXP dim_genSEXP, SEXP m_genSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SampleLIM_rotating(SEXP PSEXP, SEXP TSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::Reference >::type P(PSEXP);
...
// rounding
Rcpp::List rounding(Rcpp::Reference P, Rcpp::Nullable<Rcpp::List> settings, Rcpp::Nullable<double> seed);
RcppExport SEXP _SampleLIM_rounding(SEXP PSEXP, SEXP settingsSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::Reference >::type P(PSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<double> >::type seed(seedSEXP);
    rcpp_result_gen = Rcpp::wrap(rounding(P, settings, seed));
    return rcpp_result_gen;
END_RCPP
}
// sample_points
...
// volume
double volume(Rcpp::Reference P, Rcpp::Nullable<Rcpp::List> settings, bool rounding);
RcppExport SEXP _SampleLIM_volume(SEXP PSEXP, SEXP settingsSEXP, SEXP roundingSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::Reference >::type P(PSEXP);
...
RcppExport SEXP _SampleLIM_write_sdpa_format_file(SEXP spectrahedronSEXP, SEXP objective_functionSEXP, SEXP output_fileSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SampleLIM_zono_approx(SEXP ZSEXP, SEXP fit_ratioSEXP, SEXP settingsSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_SampleLIM_copula", (DL_FUNC) &_SampleLIM_copula, 6},
    {"_SampleLIM_direct_sampling", (DL_FUNC) &_SampleLIM_direct_sampling, 2},
    {"_SampleLIM_exact_vol", (DL_FUNC) &_SampleLIM_exact_vol, 1},
    {"_SampleLIM_frustum_of_simplex", (DL_FUNC) &_SampleLIM_frustum_of_simplex, 2},
    {"_SampleLIM_inner_ball", (DL_FUNC) &_SampleLIM_inner_ball, 1},
    {"_SampleLIM_load_sdpa_format_file", (DL_FUNC) &_SampleLIM_load_sdpa_format_file, 1},
    {"_SampleLIM_poly_gen", (DL_FUNC) &_SampleLIM_poly_gen, 6},
    {"_SampleLIM_rotating", (DL_FUNC) &_SampleLIM_rotating, 3},
    {"_SampleLIM_rounding", (DL_FUNC) &_SampleLIM_rounding, 3},
    {"_SampleLIM_sample_points", (DL_FUNC) &_SampleLIM_sample_points, 4},
    {"_SampleLIM_volume", (DL_FUNC) &_SampleLIM_volume, 3},
    {"_SampleLIM_write_sdpa_format_file", (DL_FUNC) &_SampleLIM_write_sdpa_format_file, 3},
    {"_SampleLIM_zono_approx", (DL_FUNC) &_SampleLIM_zono_approx, 4},
    {NULL, NULL, 0}
};
